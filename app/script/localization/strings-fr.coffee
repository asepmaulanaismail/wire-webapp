...
z.string.fr.auth_verify_code_description = 'Entrez le code de vérification que nous avons envoyé au %@number.'
...
z.string.fr.auth_verify_password_headline = 'Entrez votre mot de passe'

# Authentication: limit section
z.string.fr.auth_limit_devices_headline = 'Appareils'
z.string.fr.auth_limit_description = 'Supprimez un de vos autres périphériques pour commencer à utiliser Wire sur celui-ci.'
...
z.string.fr.auth_posted_change_email = 'Modifier l’adresse email'
z.string.fr.auth_posted_offline_detail = 'Vérifiez votre connexion Internet et réessayez.'
z.string.fr.auth_posted_offline_headline = 'En ligne, Wire est plus beau.'
z.string.fr.auth_posted_pending_detail = 'Vérifiez votre boîte de réception ou renvoyez l’activation.'
z.string.fr.auth_posted_pending_headline = 'Ce compte existe déjà'
z.string.fr.auth_posted_resend = 'Renvoyer à %email'
z.string.fr.auth_posted_resend_action = 'Aucun mail à l’horizon ?'
z.string.fr.auth_posted_resend_detail = 'Vérifiez votre boîte mail et suivez les instructions.'
z.string.fr.auth_posted_resend_headline = 'Vous avez du courrier.'
z.string.fr.auth_posted_retry = 'Réessayer et envoyer un mail à %email'
z.string.fr.auth_posted_retry_action = 'Réessayer ?'
z.string.fr.auth_posted_retry_detail = 'Veuillez réessayer.'
z.string.fr.auth_posted_retry_headline = 'Une erreur est survenue'
z.string.fr.auth_posted_verify_later = 'Vérifier plus tard'

#Authentication: Misc
z.string.fr.auth_placeholder_email = 'Email'
z.string.fr.auth_placeholder_name = 'Nom'
...
z.string.fr.auth_error_code = 'Code invalide'
z.string.fr.auth_error_country_code_invalid = 'Indicatif du pays invalide'
z.string.fr.auth_error_email_exists = 'Adresse email déjà utilisée'
z.string.fr.auth_error_email_forbidden = 'Désolé. Cette adresse email est bannie.'
z.string.fr.auth_error_email_malformed = 'Veuillez saisir une adresse email valide.'
z.string.fr.auth_error_email_missing = 'Veuillez saisir une adresse email.'
z.string.fr.auth_error_misc = 'Problèmes avec la connexion. Veuillez réessayer.'
z.string.fr.auth_error_name_short = 'Entrez un nom composé d’au moins 3 caractères'
...
z.string.fr.call_decline = 'Décliner'
...
z.string.fr.modal_button_send = 'Envoyer'

# Block a user
z.string.fr.modal_block_conversation_headline = 'Bloquer %@.name ?'
z.string.fr.modal_block_conversation_message = '%@.name ne pourra plus vous contacter ou vous ajouter à des conversations de groupe.'
...
z.string.fr.modal_call_conversation_empty_message = 'Il n’y a plus personne ici.'
# Cannot create the call because there are too many participants (conversation_full)
z.string.fr.modal_call_conversation_full_headline = 'Trop de personnes pour appeler'
z.string.fr.modal_call_conversation_full_message = 'Les appels fonctionnent dans des conversations avec jusqu’à %no personnes.'
# Cannot video call in group conversations
z.string.fr.modal_call_no_video_in_group_headline = 'Pas d’appel vidéo en groupe'
z.string.fr.modal_call_no_video_in_group_message = 'Les appels vidéo ne sont pas disponibles dans les conversations de groupe.'
# Second incoming call
z.string.fr.modal_call_second_incoming_headline = 'Répondre à l’appel ?'
z.string.fr.modal_call_second_incoming_message = 'Votre appel en cours sera terminé.'
z.string.fr.modal_call_second_incoming_action = 'Répondre'
# Second ongoing call
z.string.fr.modal_call_second_ongoing_headline = 'Raccrocher l’appel d’un autre appareil ?'
z.string.fr.modal_call_second_ongoing_message = 'Vous ne pouvez être que dans un appel à la fois.'
z.string.fr.modal_call_second_ongoing_action = 'Raccrocher'
...
z.string.fr.modal_call_voice_channel_full_message = 'Il n’y a de place que pour %no personnes ici.'
# Clear a conversation
z.string.fr.modal_clear_conversation_headline = 'Supprimer le contenu "%@.name" ?'
...
# Connected device
z.string.fr.modal_connected_device_headline = 'Votre compte a été utilisé le :'
z.string.fr.modal_connected_device_from = 'Depuis :'
z.string.fr.modal_connected_device_message = 'Si vous n’êtes pas à l’origine de cela, supprimez le périphérique et changez votre mot de passe.'
z.string.fr.modal_connected_device_manage_devices = 'Gérer les appareils'
# Delete account
z.string.fr.modal_delete_account_action = 'Supprimer'
z.string.fr.modal_delete_account_headline = 'Supprimer le compte'
z.string.fr.modal_delete_account_message = 'Nous allons envoyer un email ou un SMS. Cliquez sur le lien pour supprimer définitivement votre compte.'
# Delete message
z.string.fr.modal_delete_button = 'Supprimer'
z.string.fr.modal_delete_headline = 'Supprimer seulement pour moi ?'
z.string.fr.modal_delete_message = 'Cela est irréversible.'
# Delete message
z.string.fr.modal_delete_everyone_button = 'Supprimer'
z.string.fr.modal_delete_everyone_headline = 'Supprimer pour tout le monde ?'
z.string.fr.modal_delete_everyone_message = 'Cela est irréversible.'
# Too long message
z.string.fr.modal_too_long_headline = 'Message trop long'
z.string.fr.modal_too_long_message = 'Vous pouvez envoyer des messages de %no caractères maximum.'
# Leave a conversation
z.string.fr.modal_leave_conversation_headline = 'Quitter la conversation "%@.name" ?'
z.string.fr.modal_leave_conversation_message = 'Les participants en seront notifiés et la conversation sera supprimée de votre liste.'
z.string.fr.modal_leave_conversation_button = 'Quitter'
# Logout
z.string.fr.modal_logout_headline = 'Supprimer les données ?'
...
# Remove device
z.string.fr.modal_remove_device_button = 'Supprimer l’appareil'
z.string.fr.modal_remove_device_headline = 'Supprimer "%device_name"'
z.string.fr.modal_remove_device_message = 'Votre mot de passe est nécessaire pour supprimer l’appareil.'
# Session Reset
z.string.fr.modal_session_reset_headline = 'La session a été réinitialisée'
...
# Connection requests
z.string.fr.connection_request_connect = 'Connecter'
z.string.fr.connection_request_ignore = 'Ignorer'

# Conversation
z.string.fr.conversation_you_nominative = 'vous'
z.string.fr.conversation_you_dative = 'vous'
z.string.fr.conversation_you_accusative = 'vous'

z.string.fr.conversation_connection_accepted = 'Connecté'
z.string.fr.conversation_connection_blocked = 'Bloqué'
z.string.fr.conversation_connection_cancel_request = 'Annuler la demande de connexion'
z.string.fr.conversation_create = ' a commencé une conversation avec %@names'
z.string.fr.conversation_create_you = ' avez commencé une conversation avec %@names'
z.string.fr.conversation_device_started_using_one = ' a commencé à utiliser'
z.string.fr.conversation_device_started_using_many = ' ont commencé à utiliser'
z.string.fr.conversation_device_unverified = ' a annulé la vérification d’un de'
z.string.fr.conversation_device_your_devices = ' vos appareils'
z.string.fr.conversation_device_user_devices = ' appareils de %@name'
z.string.fr.conversation_device_new_device_one = ' un nouvel appareil'
z.string.fr.conversation_device_new_device_many = ' nouveaux appareils'
z.string.fr.conversation_device_new_people_joined = 'nouvelles personnes sont arrivées.'
z.string.fr.conversation_device_new_people_joined_verify = ' vérifier les appareils'
...
z.string.fr.conversation_member_join_you = ' avez ajouté %@names'
z.string.fr.conversation_member_leave_left = ' est parti'
z.string.fr.conversation_member_leave_left_you = ' êtes parti'
z.string.fr.conversation_member_leave_removed = ' a exclu %@names'
z.string.fr.conversation_member_leave_removed_you = ' avez exclu %@names'
z.string.fr.conversation_message_delivered = 'Délivré'
z.string.fr.conversation_rename = ' a renommé la conversation'
...
z.string.fr.conversation_unable_to_decrypt_1 = 'un message de %@name n’a pas été reçu.'
z.string.fr.conversation_unable_to_decrypt_2 = 'L’identité de l’appareil de %@name a changé. Message non délivré.'
z.string.fr.conversation_unable_to_decrypt_link = 'Pourquoi ?'
z.string.fr.conversation_unable_to_decrypt_error_message = 'Erreur'
z.string.fr.conversation_unable_to_decrypt_reset_session = 'Réinitialiser la session'
z.string.fr.conversation_missed_messages = 'Vous n’avez pas utilisé cet appareil depuis un moment. Il est possible que certains messages n’apparaissent pas ici.'
z.string.fr.conversation_asset_uploading = 'Envoi en cours…'
z.string.fr.conversation_asset_downloading = 'Téléchargement en cours…'
z.string.fr.conversation_asset_upload_failed = 'Échec de l’envoi'
z.string.fr.conversation_asset_upload_too_large = 'Vous pouvez envoyer des fichiers jusqu’à %no'
z.string.fr.conversation_playback_error = 'Lecture impossible'
z.string.fr.conversation_context_menu_edit = 'Modifier'
z.string.fr.conversation_context_menu_delete = 'Effacer pour moi'
z.string.fr.conversation_context_menu_delete_everyone = 'Effacer pour tout le monde'
z.string.fr.conversation_context_menu_download = 'Télécharger'
z.string.fr.conversation_context_menu_like = 'J’aime'
z.string.fr.conversation_context_menu_unlike = 'Je n’aime plus'
...
z.string.fr.fullsearch_no_results = 'Aucun résultat.'

# Archive
z.string.fr.archive_header = 'Archiver'

# Conversations
z.string.fr.conversations_all_archived = 'Tout a été archivé'
...
z.string.fr.conversations_empty_conversation = 'Conversation vide'
...
z.string.fr.conversations_popover_leave = 'Partir'
z.string.fr.conversations_popover_notify = 'Ne pas me notifier'
z.string.fr.conversations_popover_silence = 'Désactiver le micro'
...
z.string.fr.people_confirm_label = 'Ajouter à la conversation'
z.string.fr.people_common_contacts = 'Vous connaissez tous les deux'
z.string.fr.people_people = '%no personne(s)'
z.string.fr.people_search_placeholder = 'Rechercher par nom'
z.string.fr.people_everyone_participates = 'Toutes les personnes\navec qui vous êtes connectées\nsont déjà dans cette conversation.'
z.string.fr.people_no_matches = 'Pas de résultats.\nEssayez avec un nom différent.'
...
z.string.fr.people_tabs_devices_headline = 'Wire donne à chaque appareil une empreinte unique. Comparez-les avec %@.name et vérifiez votre conversation.'
z.string.fr.people_tabs_devices_why_verify = 'Pourquoi vérifier une conversation ?'
z.string.fr.people_tabs_no_devices_headline = '%@.name utilise une ancienne version de Wire. Aucun appareil n’est indiqué ici.'
z.string.fr.people_tabs_device_detail_all_my_devices = 'Afficher tous mes appareils'
z.string.fr.people_tabs_device_detail_device_fingerprint = 'Empreinte de l’appareil'
z.string.fr.people_tabs_device_detail_headline = 'Vérifiez que cela correspond à l’empreinte affichée sur l’appareil de %bold%@.name%end.'
...
z.string.fr.people_connect_message = 'Cela vous connectera et ouvrira la conversation avec %@.first_name.'

# Cancel a pending request
z.string.fr.people_cancel_request_headline = 'Annuler la demande ?'
z.string.fr.people_cancel_request_message = 'Annuler la demande de connexion à%@.first_name.'
...
z.string.fr.people_remove_headline = 'Supprimer ?'
z.string.fr.people_remove_message = '%@.first_name ne pourra plus envoyer ou recevoir de messages dans cette conversation.'
...
z.string.fr.people_button_connect = 'Connecter'
z.string.fr.people_button_create = 'Créer un groupe'
z.string.fr.people_button_ignore = 'Ignorer'
z.string.fr.people_button_leave = 'Partir'
z.string.fr.people_button_open = 'Ouvrir la conversation'
z.string.fr.people_button_pending = 'En attente'
z.string.fr.people_button_profile = 'Profil'
z.string.fr.people_button_remove = 'Exclure'
z.string.fr.people_button_unblock = 'Débloquer'
z.string.fr.people_button_no = 'Non'
z.string.fr.people_button_yes = 'Oui'

# Settings
z.string.fr.preferences_about = 'À propos'
z.string.fr.preferences_account = 'Compte'
z.string.fr.preferences_av = 'Audio / Vidéo'
z.string.fr.preferences_device_details = 'Détails de l’appareil'
z.string.fr.preferences_devices = 'Appareils'
z.string.fr.preferences_headline = 'Préférences'
z.string.fr.preferences_options = 'Options'

z.string.fr.preferences_about_copyright = '© Wire Swiss GmbH'
z.string.fr.preferences_about_privacy_policy = 'Politique de confidentialité'
z.string.fr.preferences_about_support = 'Assistance'
...
z.string.fr.preferences_devices_activated_on = 'Activé le %time'
z.string.fr.preferences_devices_active = 'Actif'
z.string.fr.preferences_devices_active_detail = 'Si vous ne reconnaissez pas l’un des appareils ci-dessus, enlevez-le et changez votre mot de passe.'
z.string.fr.preferences_devices_current = 'Actuels'
z.string.fr.preferences_devices_fingerprint = 'Clé de l’empreinte'
...
z.string.fr.preferences_devices_session_detail = 'Si les empreintes ne correspondent pas, réinitialisez la session afin de générer de nouvelles clés de chiffrement des deux côtés.'
z.string.fr.preferences_devices_session_reset = 'Réinitialiser la session'
z.string.fr.preferences_devices_session_ongoing = 'Réinitialisation de la session…'
z.string.fr.preferences_devices_verification = 'Vérifié'

z.string.fr.preferences_options_audio = 'Alertes sonores'
z.string.fr.preferences_options_audio_all = 'Tous'
z.string.fr.preferences_options_audio_all_detail = 'Tous les sons'
z.string.fr.preferences_options_audio_none = 'Aucun'
z.string.fr.preferences_options_audio_none_detail = 'Chuut !'
z.string.fr.preferences_options_audio_some = 'Certains'
z.string.fr.preferences_options_audio_some_detail = 'Pings et appels'
z.string.fr.preferences_options_contacts = 'Contacts'
z.string.fr.preferences_options_contacts_gmail = 'Importer depuis Gmail'
z.string.fr.preferences_options_contacts_macos = 'Importer depuis Contacts'
z.string.fr.preferences_options_contacts_detail = 'Nous utilisons les informations de vos contacts afin de vous connecter avec d’autres personnes. Nous anonymisons toutes les informations et ne les partageons pas avec qui que ce soit.'
z.string.fr.preferences_options_data = 'Rapports d’utilisation et de crash'
z.string.fr.preferences_options_data_checkbox = 'Rapports d’utilisation et de crash'
...
z.string.fr.preferences_options_notifications_obfuscate = 'Masquer les détails'
...
# Search
z.string.fr.search_group_hint = 'Continuez d’écrire ou ajoutez plus de personnes pour créer un groupe'
...
z.string.fr.url_wire = 'https://wire.com'
z.string.fr.url_wire_for_web = 'https://app.wire.com'
z.string.fr.url_support_calling = 'https://support.wire.com/hc/en-us/articles/202969412'
z.string.fr.url_support_camera_access_denied = 'https://support.wire.com/hc/en-us/articles/202935412'
z.string.fr.url_support_device_access_denied = 'https://support.wire.com/hc/en-us/articles/213512545'
z.string.fr.url_support_contact = 'https://support.wire.com/hc/en-us/requests/new'
z.string.fr.url_support_contact_bug = 'https://support.wire.com/hc/en-us/requests/new?ticket_form_id=101615'
z.string.fr.url_support_history = 'https://support.wire.com/hc/en-us/articles/207834645'
z.string.fr.url_support_mic_access_denied = 'https://support.wire.com/hc/en-us/articles/202590081'
...
z.string.fr.warning_call_detail = 'Votre navigateur doit avoir accès au micro pour faire des appels.'
z.string.fr.warning_call_headline = 'Impossible d’appeler sans micro'
z.string.fr.warning_call_unsupported_incoming = '%s.first_name vous appelle. Votre navigateur ne supporte pas les appels.'
z.string.fr.warning_call_unsupported_outgoing = 'Vous ne pouvez pas appeler parce que votre navigateur ne supporte pas les appels.'
z.string.fr.warning_call_issues = 'Cette version de Wire ne peut pas participer à cet appel. Utilisez plutôt'
z.string.fr.warning_call_upgrade_browser = 'Pour pouvoir appeler, mettez à jour Google Chrome.'
z.string.fr.warning_learn_more = 'En savoir plus '
z.string.fr.warning_not_found_camera = 'Vous ne pouvez pas appeler car votre ordinateur ne dispose pas d’une webcam.'
z.string.fr.warning_not_found_microphone = 'Vous ne pouvez pas appeler car votre ordinateur ne dispose pas d’un micro.'
z.string.fr.warning_permission_denied_camera = 'Vous ne pouvez pas appeler car votre navigateur n’a pas accès à votre webcam.'
z.string.fr.warning_permission_denied_microphone = 'Vous ne pouvez pas appeler car votre navigateur n’a pas accès à votre micro.'
z.string.fr.warning_permission_denied_screen = 'Votre navigateur a besoin de votre permission pour partager votre écran.'
z.string.fr.warning_permission_request_camera = '%icon Autoriser l’accès à la webcam'
z.string.fr.warning_permission_request_microphone = '%icon Autoriser l’accès au micro'
...
z.string.fr.warning_tell_me_how = 'Dites-moi comment'

# Warnings: Connectivity
z.string.fr.warning_connectivity_connection_lost = 'Tentative de connexion. Wire peut ne pas être en mesure d’envoyer des messages.'
...
z.string.fr.system_notification_member_join_many = '%s.first_name a ajouté %no personnes à la conversation'
z.string.fr.system_notification_member_join_one = '%s.first_name a ajouté %@.first_name à la conversation'
z.string.fr.system_notification_member_leave_left = '%s.first_name a quitté la conversation'
z.string.fr.system_notification_member_leave_removed_many = '%s.first_name a exclu %no personnes de la conversation'
z.string.fr.system_notification_member_leave_removed_one = '%s.first_name a exclu %@.first_name de la conversation'
...
z.string.fr.system_notification_reaction = '%reaction votre message'
z.string.fr.system_notification_shared_audio = 'A partagé un message audio'
z.string.fr.system_notification_shared_file = 'A partagé un fichier'
z.string.fr.system_notification_shared_location = 'A partagé un emplacement'
z.string.fr.system_notification_shared_video = 'A partagé une vidéo'
z.string.fr.system_notification_voice_channel_activate = 'Appel en cours'
z.string.fr.system_notification_voice_channel_deactivate = 'vous a appelé'

# Tooltips
z.string.fr.tooltip_conversation_all_verified = 'Toutes les empreintes sont vérifiées'
z.string.fr.tooltip_conversation_call = 'Appel'
...
z.string.fr.tooltip_conversation_video_call = 'Appel vidéo'

z.string.fr.tooltip_conversations_archive = 'Archiver (%shortcut)'
z.string.fr.tooltip_conversations_archived = 'Voir les archives (%no)'
...
z.string.fr.tooltip_people_block = 'Bloquer'
z.string.fr.tooltip_people_connect = 'Connecter'
z.string.fr.tooltip_people_leave = 'Quitter la conversation'
z.string.fr.tooltip_people_open = 'Ouvrir la conversation'
z.string.fr.tooltip_people_profile = 'Ouvrir votre profil'
z.string.fr.tooltip_people_rename = 'Changer le nom de la conversation'
...
z.string.fr.ephememal_units_minutes = 'minutes'
z.string.fr.ephememal_units_hour = 'heure'
